...
def main(fname: str, display: bool):
    ...
    fid_dis_left_to_right_pixels = np.sqrt((fiducials[0][0] - fiducials[3][0])**2 + (fiducials[0][1] - fiducials[3][1])**2)
    ...
    found_distance = distance_finder(avg_fl, fid_dis_left_to_right, fid_dis_left_to_right_pixels)
